...
//        int colorWhite = activity.getResources().getColor(R.color.colorPrimary);
//        if (colorWhite == color && Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
...
//        }
    ...
    public static void setNavBarColor(Activity activity, @ColorInt int color) {
        activity.getWindow().clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_NAVIGATION);
        activity.getWindow().setNavigationBarColor(calculateStatusColor(color, 0));
    }
    ...
    public static void cancelStatusBar(Activity activity) {
        activity.getWindow()
                .getDecorView()
