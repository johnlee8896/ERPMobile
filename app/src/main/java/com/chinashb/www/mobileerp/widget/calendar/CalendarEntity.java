...
public final class CalendarEntity implements Serializable {
     ...
     * 获取完整的农历日期
     */
    private CalendarEntity lunarCalendar;

    private BottomMarkDotBean bottomMarkDotBean;

    public BottomMarkDotBean getBottomMarkDotBean() {
        return bottomMarkDotBean;
    }

    public void setBottomMarkDotBean(BottomMarkDotBean bottomMarkDotBean) {
        this.bottomMarkDotBean = bottomMarkDotBean;
    }
    ...
    public CalendarEntity getLunarCalendar() {
        return lunarCalendar;
    }

    public void setLunarCalendar(CalendarEntity lunarCalendar) {
    ...
    public boolean equals(Object o) {
        if (o != null && o instanceof CalendarEntity) {
            if (((CalendarEntity) o).getYear() == year && ((CalendarEntity) o).getMonth() == month && ((CalendarEntity) o).getDay() == day) {
                return true;
            }
        }
