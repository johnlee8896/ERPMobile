...
//            getWCList();
    ...
    private void handleSelectNO() {
        if (commonSelectInputDialog == null) {
            commonSelectInputDialog = new CommonSelectInputDialog(BuWarehouseAccountInActivity.this);
        }
...
//                    CommonUtil.ShowToast(ProductScanBoxInActivity.this, "入库完成" + ws_result.getErrorInfo(), R.mipmap.smiley);
                    CommonUtil.ShowToast(BuWarehouseAccountInActivity.this, "入库完成", R.mipmap.smiley);
                    hasScanItem = false;
                    inputEditText.setText("");
