    ...
    void setButtonClick() {
        btnSelectCheckFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ProductCommonCheckInventoryActivity.this, SelectItemActivity.class);
//                Intent intent = new Intent(ProductCommonCheckInventoryActivity.this, CommonSelectItemActivity.class);
...
//                        "Datediff(day, Insert_Time, Getdate())<30 ";
        ...
        btnScanIst.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (SelectCI == null) {
                    Toast.makeText(ProductCommonCheckInventoryActivity.this, "请先选择盘点表", Toast.LENGTH_LONG).show();
                    inputEditText.setText("");
                    return;
                }
                new IntentIntegrator(ProductCommonCheckInventoryActivity.this).setCaptureActivity(CustomScannerActivity.class).initiateScan();
    ...
    private class GetIstAsyncTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            if (istPlaceEntity.getResult()) {
                ...
                Toast.makeText(ProductCommonCheckInventoryActivity.this, istPlaceEntity.getErrorInfo(), Toast.LENGTH_LONG).show();
...
//                       0L, qty, N, PN, DQ, remark, storeArea, manuLotNO);
        ...
        protected void onPostExecute(Void result) {
            if (ws_result.getResult()) {
                CommonUtil.ShowToast(ProductCommonCheckInventoryActivity.this,
