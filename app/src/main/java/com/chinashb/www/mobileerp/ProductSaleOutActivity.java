...
public class ProductSaleOutActivity extends BaseActivity implements View.OnClickListener {
    ...
    @BindView(R.id.product_out_delivery_order_detail_customRecyclerView) CustomRecyclerView orderDetailRecyclerView;
    @BindView(R.id.product_out_delivery_order_info_textView) TextView orderInfoTextView;
