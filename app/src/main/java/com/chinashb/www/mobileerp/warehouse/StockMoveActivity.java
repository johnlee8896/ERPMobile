...
//物品条码
                                ...
                                StockMoveActivity.AsyncGetBox task = new StockMoveActivity.AsyncGetBox();
                                task.execute();
                            }
                        ...
                        if (X.startsWith("/SUB_IST_ID/")||X.startsWith("/IST_ID/"))
                        {
                            ...
                            StockMoveActivity.AsyncGetIst task = new StockMoveActivity.AsyncGetIst();
                            task.execute();
    ...
    private class AsyncExeWarehouseMove extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            while(count<selectedcount && SelectList.size()>0)
            {
                ...
                Ws_Result result = WebServiceUtil.op_Commit_Move_Item(bi);
