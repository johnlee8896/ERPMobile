...
public class SearchJsonListAdapter extends BaseRecycleAdapter<BUItemBean, SearchJsonListAdapter.SearchListViewHolder> {
    @Override
    ...
    public static class SearchListViewHolder extends BaseViewHolder {
