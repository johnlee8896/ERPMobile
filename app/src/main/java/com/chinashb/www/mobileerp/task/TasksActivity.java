...
public class TasksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rvTasks =(RecyclerView)findViewById(R.id.rv_task_list);
        tasks =new ArrayList<>();
        TaskJsonListAdapter jsonListAdapter= new TaskJsonListAdapter(this, tasks);
        rvTasks.setAdapter(jsonListAdapter);
    ...
    private class AsyncGetTasks extends AsyncTask<String, Void, Void> {
        ...
        private String getSqlTaskSelectField(){
           String sql=  " Select (Case When BigJob=0 Then 0 Else TTask_Ver.TTP_ID End) As TTP_ID, " +
                   "~ Isnull(TTask_Exer.Confirmed,1) As New, "+
                    ...
                    "        (Select Max(access_time) From TTask_Access Where Visitor=" + HR_ID + " Group by Tid having Tid=TTask.Tid) As 最近访问 " ;
           return  sql;
        }
        ...
        private String getSqlTaskFrom(){
            String From =" From TTask_Ver " +
                    ...
                    " And TTask_Exer.Exer=" + HR_ID + " And Isnull(TTask_Exer.Quit,0)=0 ";
            return From;
        }
        ...
        protected void getUserPics(){
            ...
            if (Hr_IDs==null){return;}
            if (Hr_IDs.size()==0){return;}
        ...
        {
            String s= " Where Not Isnull(TTPlan.Closed,0)=1 And TTask_Ver.Exer_Dep_ID In (Select Distinct Department_ID From HR_Adm Where Hr_ID= " + HR_ID + ") ";
            return s;
        }
        ...
        protected void bindObjectListsToAdapter(final List<JsonObject> JList){
            ...
            rvTasks.setAdapter(ObjectAdapter);
