...
public class TaskCreateFullActivity extends BaseActivity implements View.OnClickListener, OnViewClickListener {
    ...
    private void initViews() {
        ...
        timePickerManager = new TimePickerManager(TaskCreateFullActivity.this);
    }
    ...
    private void showTimePickerDialog(String pickType) {
        timePickerManager
                .setOnViewClickListener(TaskCreateFullActivity.this)
                .showDialog(pickType);
    }
