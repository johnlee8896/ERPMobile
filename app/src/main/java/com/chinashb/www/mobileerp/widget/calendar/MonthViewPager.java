...
public final class MonthViewPager extends ViewPager {
        ...
        addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (mDelegate.monthChangeListener != null) {
                    mDelegate.monthChangeListener.onMonthChange(calendar.getYear(), calendar.getMonth());
                }
                ...
                if (mDelegate.dateSelectedListener != null && !isUsingScrollToCalendar) {
                ...
                if (view != null) {
                    int index = view.getSelectedIndex(mDelegate.selectedCalendar);
                    view.currentClickItem = index;
    ...
    void scrollToCalendar(int year, int month, int day, boolean smoothScroll) {
        ...
        MonthView view = (MonthView) findViewWithTag(position);
        if (view != null) {
            view.setSelectedCalendar(mDelegate.selectedCalendar);
            view.invalidate();
            if (mParentLayout != null) {
                mParentLayout.setSelectPosition(view.getSelectedIndex(mDelegate.selectedCalendar));
            }
        }
        if (mParentLayout != null) {
        ...
        if (mDelegate.innerListener != null) {
            mDelegate.innerListener.onMonthDateSelected(calendar, false);
        }

        if (mDelegate.dateSelectedListener != null) {
            mDelegate.dateSelectedListener.onDateSelected(calendar, false);
        }
        updateSelected();
    }
    ...
    void scrollToCurrent(boolean smoothScroll) {
        ...
        if (mDelegate.dateSelectedListener != null && getVisibility() == VISIBLE) {
            mDelegate.dateSelectedListener.onDateSelected(mDelegate.createCurrentDate(), false);
        }
    }
    ...
    void updateShowMode() {
        ...
        if (mDelegate.getMonthViewShowMode() == CalendarViewDelegate.MODE_ALL_MONTH) {
            ...
            updateMonthViewHeight(mDelegate.selectedCalendar.getYear(), mDelegate.selectedCalendar.getMonth());
        }
        ViewGroup.LayoutParams params = getLayoutParams();
        params.height = mCurrentViewHeight;
        setLayoutParams(params);
    ...
    void updateWeekStart() {
        ...
        setLayoutParams(params);
        if (mParentLayout != null) {
            int i = CalendarUtil.getWeekFromDayInMonth(mDelegate.selectedCalendar, mDelegate.getWeekStart());
            mParentLayout.setSelectWeek(i);
        }
    }
    ...
    private class MonthViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ...
            view.parentLayout = mParentLayout;
