...
/***
 * @date 创建时间 2024/5/24 4:29 PM
 * @author 作者: liweifeng
 * @description 成品扫描盘点
 */
public class ProductCheckInventoryActivity extends BaseActivity {
    ...
    void setButtonClick() {
        btnSelectCheckFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ProductCheckInventoryActivity.this, SelectItemActivity.class);
//                Intent intent = new Intent(ProductCheckInventoryActivity.this, CommonSelectItemActivity.class);
...
//                        "Datediff(day, Insert_Time, Getdate())<30 ";
        ...
        btnScanIst.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (SelectCI == null) {
                    Toast.makeText(ProductCheckInventoryActivity.this, "请先选择盘点表", Toast.LENGTH_LONG).show();
                    inputEditText.setText("");
                    return;
                }
                new IntentIntegrator(ProductCheckInventoryActivity.this).setCaptureActivity(CustomScannerActivity.class).initiateScan();
    ...
    private class GetIstAsyncTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            if (istPlaceEntity.getResult()) {
                ...
                Toast.makeText(ProductCheckInventoryActivity.this, istPlaceEntity.getErrorInfo(), Toast.LENGTH_LONG).show();
...
//                       0L, qty, N, PN, DQ, remark, storeArea, manuLotNO);
        ...
        protected void onPostExecute(Void result) {
            if (ws_result.getResult()) {
                CommonUtil.ShowToast(ProductCheckInventoryActivity.this,
