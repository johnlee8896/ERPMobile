...
final class CameraConfigurationManager {
    ...
    void initFromCameraParameters(Camera camera) {
        Point screenResolution = BGAQRCodeUtil.getScreenResolution(context);
        ...
        previewResolution = getPreviewResolution(camera.getParameters(), screenResolutionForCamera);

        if (BGAQRCodeUtil.isPortrait(context)) {
            cameraResolution = new Point(previewResolution.y, previewResolution.x);
        } else {
